...
$stmt = $pdo->prepare(
    "SELECT hfp.*, s.name, s.ad_no, s.class, s.section, s.roll
     FROM transport_fee_payments hfp
...
if (!$p) {
    die('Transport receipt not found.');
}
...
$transportInfo = getStudentTransportDetails($pdo, (int) $p['student_id']);
...
<head>
    ...
    <title>Transport Receipt <?php echo htmlspecialchars($p['receipt_no']); ?> — <?php echo htmlspecialchars($brandName); ?></title>
    ...
    <style>
        ...
        .rc-transport-banner span { color: #94a3b8; font-weight: 700; text-transform: uppercase; letter-spacing: 0.04em; display: block; font-size: 0.52rem; }
        .rc-transport-banner strong { color: #0f172a; font-weight: 700; }
    </style>
</head>
<body>
    <div class="rc-toolbar no-print">
        <h1><i class="fas fa-bus"></i> Transport Fee Receipt</h1>
        <div class="rc-actions">
            <a href="transport_fee_collect.php?student_id=<?php echo (int) $p['student_id']; ?>" class="rc-btn rc-btn-ghost"><i class="fas fa-arrow-left"></i> Back</a>
    ...
    <div class="rc-receipt">
        ...
        <div class="rc-header">
            ...
            <div class="rc-doc-label">
                <span class="lbl">Transport Fee Receipt</span>
            </div>
        </div>
        ...
        <div class="rc-transport-banner">
            <div><span>Route</span><strong><?php echo htmlspecialchars($transportInfo['route_name']); ?></strong></div>
            <div><span>Stop</span><strong><?php echo htmlspecialchars($transportInfo['stop_name'] ?: '—'); ?></strong></div>
            <?php if (!empty($transportInfo['vehicle_no'])): ?>
            <div><span>Vehicle</span><strong><?php echo htmlspecialchars($transportInfo['vehicle_no']); ?></strong></div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="rc-body">
            ...
            <table class="rc-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            Transport Fee<?php echo $feeMonthLabel ? ' · ' . htmlspecialchars($feeMonthLabel) : ''; ?>
        ...
        <div class="rc-footer">
            <p class="rc-note">Computer-generated transport fee receipt. Please retain for your records.</p>
            <div class="rc-sign">
